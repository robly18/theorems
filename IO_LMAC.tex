...
Caso contrário:
	...
	\begin{prop}
	Considere-se o pol $n$-dimensional:
	...
	Dizemos que este é \emph{não-degenerado no sentido estrito} se qualquer conjunto de $n$ colunas de $A$ são linearmente independentes.
	
	Um pol não-degenerado no sentido estrito também o é no sentido lato.
	\end{prop}
	
	\begin{proof}
	%todo first of all make sure this is actually true
	\end{proof}
