...
Since we wiill be working on the real line, we will use the nomenclature `binary intervals' instead of cubes.
...
For $i = 0, 1, 2, \dots$, put $d_i$ the maximal integer $d$ such that

\[ \left( \sum_{j = 0}^{i-1} d_j b^{k-j} \right) + d b^{k-i} \leq t.\]
\label{digalg}
