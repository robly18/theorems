...
If $I = R_{b^\eta}(a)$ is a $b$-ary interval, its transform is given by:
...
The only way for the limit to be nontrivial is for this series to be the constant one, and so for $\sigma_1$ to be $(2 \gamma)^s$. Hence, let us calculate $\sigma_1$.
...
\bibitem{fefferman}
Fefferman, C. - "The Multiplier Problem for the Ball", \textit{Annals of Mathematics}, \textbf{94}, 330-336 (1971).
