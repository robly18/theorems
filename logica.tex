...
\begin{document}
	...
	Começamos por mostrar que para um conjunto de axiomas nos dar um cálculo correto e completo é necessário e suficiente que, em certo sentido, chegam para descrever as tautologias todas.
	...
	\begin{enumerate}
	\item Se $\varphi_1$ é um axioma, é necessário $\alpha \imply \varphi$
	...
	\begin{gather*}
	\alpha \imply \alpha\\
	\alpha \imply (\beta \imply \alpha)\\
	[\alpha \imply (\beta \imply \gamma)] \imply [(\alpha \imply \beta) \imply (\alpha \imply \gamma)].
	\end{gather*}
