...
\begin{document}
	...
	Se $\rho(\bf x_{N+1}) = \lt$, então por construção isso significa que $\Gamma, r(\bf x_1), \dots, r(\bf x_N), \bf x_{N+1} \nvdash \varphi$, que, como neste caso $r(\bf x_{N+1})$ é $\bf x_{N+1}$, mostra o desejado.
	...
	Sabendo que a hipótese $\bf x_{N+1} \lor \neg \bf x_{N+1}$ é uma tautologia, pode ser retirada das hipóteses (ver lema \ref{lemma:2}), pelo que concluímos
