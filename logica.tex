...
def f(x):
	...
	\begin{obstaculo}
	Poderá não haver termos fechados de todo, em particular se não houver nenhum símbolo de função de aridade zero. No entanto, numa estrutura de interpretação é necessário o universo ser não-vazio. Como tal, será necessário adicionar alguns termos novos para servir de semente, para criar mais termos.
	\end{obstaculo}
