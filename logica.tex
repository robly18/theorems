...
\begin{document}
	...
	\smallskip
	A implicação no outro sentido é um pouco mais elaborada, e introduz a ideia de prova que é construção de demonstrações. (todo)
	\end{proof}
	
	Começamos por mostrar um facto elementar sobre o comportamento do operador `ou'.
