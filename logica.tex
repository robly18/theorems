...
def f(x):
	...
	Dizemos que $I$ satisfaz $\varphi$ se, para \emph{todas} as valorações $\rho$ sobre $I$, $\rho \Vdash \varphi$. Por outras palavras, `$\varphi$ é sempre verdade no universo $I$'.
