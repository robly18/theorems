...
Dados dois vetores $x,y \in \R^n$, dizemos $x \leq y$ se $x_i \leq y_i$ para todo $i$.
	...
	Primeiramente, vamos tentar definir o que queremos dizer por `vértice'.
	...
	Estamos agora prontos para caraterizar o que queremos dizer com `vértice', ao menos neste contexto.
