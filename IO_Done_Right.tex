...
Caso contrário:
  ...
  Para todo o $B \subseteq N$ tal que $\#B = k$:
	...
	\begin{definition}
	Sejam $a_1, a_2, \cdots, a_r$ vetores de $\R^n$. O \emph{cone formado por $a_1, \cdots, a_r$} é o conjunto: \footnote{O leitor poderá perguntar-se o que acontece ao cone gerado por zero elementos. Neste caso, o nosso conjunto será o conjunto que contém apenas um elemento ($\R^0$ tem um elemento, e todos os seus índices são $\geq 0$) e este será a soma vazia, que dá zero. Logo, o cone gerado pelo vazio é o conjunto $\{0\}$. Tendo isto em conta, é fácil ver que o conjunto vazio \emph{não} é um cone sob esta definição.}
