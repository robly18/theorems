...
Dados dois vetores $x,y \in \R^n$, dizemos $x \leq y$ se $x_i \leq y_i$ para todo $i$.
	...
	Estamos agora prontos para tentar caraterizar os vértices de conjuntos admissíveis de pols na forma padrão. A seguinte proposição ser-nos-á útil:
	...
	Assim sendo, isso limita as nossas escolhas de $h$. Este tem necessáriamente as casas em $N \setminus P_x$ igual a zero, pelo que resta definir $h_{P_x}$.
