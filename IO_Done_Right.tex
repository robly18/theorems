...
Caso contrário:
  ...
  Para todo o $B \subseteq N$ tal que $\#B = k$:
	...
	Um destes métodos é o chamado \emph{método das linhas ativas}, e vamos esboçar metade da sua prova de funcionamento, com o intuito de motivar o que se segue.
	...
	\begin{definition}
	Dado um vetor $x$ de $X_P$, $A^x$ representa a matriz das linhas ativas de $A$.
	\end{definition}
