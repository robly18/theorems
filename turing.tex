...
\begin{document}
	...
	This also provides us an easy invariant: if we make sure that every run of $\M$ decreases the length of $s_i$ by at least one, we are sure that the program will eventually halt.
