...
\end{tikzpicture}
	...
	Graficamente (o tempo de execução do HCELIPS é representado pelas cruzes, o tempo de execução do HCEIPS pelos círculos):
	
	\begin{tikzpicture}
	\begin{axis}[axis lines = middle, xmin=0, ymin=0, xlabel = $\eta$, ylabel = $\Theta_{exec}$]
